...
class PropertyNotificationMailerTest < ActionMailer::TestCase
  test "create_notification" do
    mail = PropertyNotificationMailer.create_notification
  ...
  test "update_notification" do
    mail = PropertyNotificationMailer.update_notification
  ...
  test "delete_notification" do
    mail = PropertyNotificationMailer.delete_notification
